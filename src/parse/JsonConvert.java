...
public class JsonConvert {
	...
	public static void main(String[] args) {
        ...
        try {  
            brname = new BufferedReader(new FileReader("E:/Workspaces/MyEclipse 2016 CI/testFile/nameID.txt"));// 读取NAMEID对应值  
            String sname = null;  
        ...
        // 读取原始json文件并进行操作和输出  
        try {  
            BufferedReader br = new BufferedReader(new FileReader("E:/Workspaces/MyEclipse 2016 CI/testFile/HK_geo.json"));// 读取原始json文件  
            BufferedWriter bw = new BufferedWriter(new FileWriter("E:/Workspaces/MyEclipse 2016 CI/testFile/HK_new.json"));// 输出新的json文件  
